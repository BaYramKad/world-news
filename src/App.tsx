...
import CountYears from './components/years/count-years';
import Title from './components/title';
import News from './components/news-container/news';
import SwiperButtonsContainer from './components/buttons/swiper-buttons-container';
import { SwiperCircle } from './shared/swiper-circle';

import { news, slides, SlidesType } from './shared/sourse';
import { useWindowWidthMoreThan } from './shared/hooks/useWindowResize';
...
const App = () => {
  ...
  const isMobile = useWindowWidthMoreThan(1000);
